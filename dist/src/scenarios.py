...
# path_installer.resource_path('assets/language.json')
if not os.path.exists(path_installer.get_appdata_path('language.json')):
    copyfile(path_installer.resource_path('assets/language.json'),
             path_installer.get_appdata_path('language.json'))


with open(path_installer.get_appdata_path('language.json'), encoding='utf-8') as languages_file:
...
class Scenario:
    ...
    def set_current_language(language):
        ...
        with open(path_installer.get_appdata_path('language.json'), 'w', encoding='utf-8') as languages_file:
